...
**storage**: the SecureStore-compatible storage used to cache session data and cookies. Reuse the same storage instance across clients that access the same stored data.
