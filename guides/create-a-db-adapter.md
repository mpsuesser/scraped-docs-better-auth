...
The `createSchema` method allows the [Better Auth CLI](https://better-auth.com/docs/concepts/cli) to [generate](https://better-auth.com/docs/concepts/cli#generate) a schema for the database.
